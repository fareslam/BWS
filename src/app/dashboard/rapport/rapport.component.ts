...

  {
    ...
    if (this.module=='Alert')
          {
            //Methode Alert By Ref
              ...
              if (this.type=='PDF')
                      {
                        this.userService.reportAlertRef(this.subuser.cin,this.reference).subscribe(
                          data => {
    ...
    if (this.module=='History')
          {
            ...
            if (this.type=='PDF')
                      {
                        this.userService.reportHistorytRef(this.subuser.cin,this.reference).subscribe(
                          data => {
   ...
   /* if ((this.alert==true) && (this.history==true))
          { //alert(this.reference)
            ...
            if (this.type=='PDF')
                      {
                        this.userService.reportHistoryAlertRef(this.subuser.cin,this.reference).subscribe(
                          data => {
